/**
 * 代码取自typescript-json-schema库,在其基础上进行修改
 * this code is copied from 'typescript-json-schema' and modified based on it.
 * origin lib: https://github.com/YousefED/typescript-json-schema
 */
...
export class JsonSchemaGenerator {
    ...
    public getSchemaForType(typ: ts.Type, includeReffedDefinitions: boolean = true): Definition {
...
//         return new JsonSchemaGenerator(typeChecker, settings);
//     } else {
